...
export default function CategorySidebar({ categories, selectedCategoryId, onCategoryChange }: CategorySidebarProps) {
  return (
    <aside className='w-56 shrink-0'>
      <div className='bg-wow-panel border-wow-border-light before:border-wow-border-gold/20 sticky top-4 rounded-sm border before:pointer-events-none before:absolute before:inset-px before:rounded-sm before:border'>
